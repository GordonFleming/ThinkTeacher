    ...
    <div class="container-fluid justify-content-center">
        ...
        <div class="collapse navbar-collapse" id="navbar">
            <ul class="navbar-nav nav-fill me-auto w-100">
                <li class:active={$page.path === '/about'} class="nav-item pt-lg-4">
                    <a style="width: 10vw;" class="nav-link fromLeft" sveltekit:prefetch href="/about">About</a>
                </li>
                <li class:active={$page.path === '/'} class="nav-item pt-lg-4">
                ...
                <li class:active={$page.path === '/login'} class="nav-item pt-lg-4">
                    <a style="width: 10vw;" class="nav-link fromLeft" href="/login">Login</a>
                </li>
                <li class:active={$page.path === '/contact-us'} class="nav-item pt-lg-4">
