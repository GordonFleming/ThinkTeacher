<script>
    ...
    let obj = {
        __component: "custom-form.business",
    ...
    <form id="contactPartner">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 mt-2">
                <label class="form-label form-check-label" for="business_coaching"
                    >Busines Coaching?</label
                >
                <div class="form-switch justify-content-center d-flex mt-1">
                    <input
                        ...
                        bind:checked={obj.business_coaching}
                    />
                </div>
            </div>
            <div class="col-sm-12 col-md-6 mt-2">
                <label class="form-label form-check-label" for="side_business">Side Business?</label
                >
                <div class="form-switch justify-content-center d-flex mt-1">
                    <input
                        class="form-check-input form-control"
                        ...
                        role="switch"
                        id="side_business"
                        bind:checked={obj.side_business}
                    />
                </div>
            </div>
            <div class="col-12 mt-2">
                <label class="form-label form-check-label" for="financial_health"
                ...
                <div class="form-switch justify-content-center d-flex mt-1">
                    <input
                        ...
                        role="switch"
                        id="financial_health"
                        bind:checked={obj.financial_health}
                    />
                </div>
            </div>
            <div class="col-12 mt-2">
