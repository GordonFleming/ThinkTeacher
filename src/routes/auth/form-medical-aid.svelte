							...
							<div class="mb-md-3 mt-md-2">
								...
								<form id="contactPartner">
									<div class="row">
										...
										<div class="col-sm-12 col-md-6 mt-2">
											<label class="form-label" for="dependants"
										...
										<div class="col-sm-12 col-md-6 mt-2">
											<label
												...
												for="medicalAid">Currently have Medical Aid?</label
											>
											<div class="form-switch mt-1">
												<input
													class="form-check-input form-control"
										...
										<div class="col-sm-12 col-md-6 mt-2">
											<label
												class="form-label form-check-label"
												for="gapcover">Currently have gapcover?</label
											>
											<div class="form-switch mt-1">
												<input
													class="form-check-input form-control"
									...
									<div class="col-12 mt-2">
										<label class="form-label" for="scheme"
											>What plan would you be interested in?</label
										>
										<select
											class="form-select"
											id="scheme"
										...
										>
											...
											<option value="entry_level_options"
												>Entry Level Options</option
											>
											<option value="basic_hospital_plans"
												>Basic Hospital Plans</option
											>
											<option value="better_hospital_plans"
												>Better Hospital Plans</option
											>
											<option value="hospital_plan_plus_savings"
												>Hospital Plan Plus Savings</option
											>
